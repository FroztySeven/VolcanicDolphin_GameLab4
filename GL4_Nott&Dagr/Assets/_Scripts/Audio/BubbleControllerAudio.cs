...
public class BubbleControllerAudio : MonoBehaviour
{
    [FMODUnity.EventRef]
    public string bubbleEnterExitSFX;
    ...
    void CallBubbleEnterExit()
    {
        FMODUnity.RuntimeManager.PlayOneShot(bubbleEnterExitSFX);
    }
}
